...
class FixFolderAndFileNamesCommand extends Command
{
	...
	{
		$this
			->setDescription('Fix les noms des dossiers et fichiers (enlève les espaces et caractères spéciaux).');
	}
...
//						$filesystem->rename($absoluteFilePath, $path.'/'.$fixedFilename);
						...
						$files = $queryFiles
							->andWhere('f.file LIKE :path')
							->setParameter('path', "%". $relativePathName."%")
							->getQuery()
							->getResult()
						;
